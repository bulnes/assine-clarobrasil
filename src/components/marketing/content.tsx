          ...
          <div className="lg:hidden">
            ...
            <div className="flex justify-center mb-4">
              <div className="w-full max-w-xs">
                <ImageWithFallback
                  src="https://images.unsplash.com/photo-1642724978334-218b27d2c472?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w3Nzg4Nzd8MHwxfHNlYXJjaHwxfHxzbWFydHBob25lJTIwd2hhdHNhcHAlMjBtb2NrdXAlMjBzY3JlZW58ZW58MXx8fHwxNzU4NDcxMTA5fDA&ixlib=rb-4.1.0&q=80&w=1080&utm_source=figma&utm_medium=referral"
                  alt="Mockup de celular com WhatsApp aberto"
            ...
            <div className="text-center mb-4 max-w-xs mx-auto">
              <h1 className="text-4xl font-bold text-gray-900 mb-2">
                Assine a <span className="text-[#E30613]">Claro</span> direto
                pelo WhatsApp
              </h1>
